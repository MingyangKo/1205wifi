...
const int Rled = BUILTIN_LED;
const int Gled = BUILTIN_LED;
const int Bled = BUILTIN_LED;
//char led_status[25];
String webSite;
...
void ColorPicker(){
  ...
  analogWrite(Rled,red_color);
  analogWrite(Gled,green_color);
  analogWrite(Bled,blue_color);
